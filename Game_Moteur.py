...
class flag:
    ...
    def checkpoint(self,player,bgy):
        ...
        S' il y a une collision, le module de IQA est appellé.
        Si le module de IQA retourne True (donc le joueur a répondu juste au
